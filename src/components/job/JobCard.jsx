...
const JobCard = ({ job }) => {
  return (
    <div className="soft-card bg-gray-250 p-8 rounded-xl flex flex-col justify-between h-full ">
      ...
      <div>
         <div className="flex flex-wrap gap-2 items-center mb-2  ">
          ...
          />
          <h3 className="text-sm sm:text-base font-semibold text-gray-900 py-0 px-0">
            {job.title}
          </h3>
        </div>
...
{/* apply Button  */}
        <button className="ml-auto sm:ml-0 bg-purple-800 text-white text-xs font-medium px-4 py-1.5 rounded-md hover:bg-purple-700 transition">
          Apply
        </button>
      </div>
