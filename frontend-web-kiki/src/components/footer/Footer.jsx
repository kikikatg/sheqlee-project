        ...
        <div className="grid gap-8 sm:gap-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
          <div className="space-y-6 max-w-sm sm:mt-9  text-center sm:text-left">
            ...
            <img
              ...
              alt="Sheqlee logo"
              className="h-18 grid sm:mx-0 " /* 🔧 CENTER ON MOBILE */
            />

            {/* Address */}
            <div>
              <p className="text-[14px] sm:text-[16px] font-semibold uppercase text-white">
                Address
              </p>
              <p className="text-[13px] sm:text-[15px]  text-gray-300 mt-1">
                MIT, Mekelle, Tigray
              </p>
            </div>
          </div>
