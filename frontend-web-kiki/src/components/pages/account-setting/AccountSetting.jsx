...
const InputBox = ({ label, value: initialValue, placeholder, type = "text" }) => {
...
const navigate = useNavigate();
 ...
 <div className="w-full max-w-[1295px] mx-auto px-6">
      <div className="flex flex-col items-center mb-24">
       ...
       <div className="mt-6">
        <img src="/icons/account-setting.svg" 
          alt="account-setting"
...
>
 ...
 >
  ...
  <p
  className="mt-3 max-w-[900px] mb-10 text-[22px]"
  style={{ fontFamily: "Kantumruy Pro" }}
  >
  Please note that your account will be available for recovery for a period of one month after deletion.
 ...
 <p className="mt-2 text-[20px]">
  Giving us accurate reason for your deletion will help us make Sheqlee better.
 </p>
